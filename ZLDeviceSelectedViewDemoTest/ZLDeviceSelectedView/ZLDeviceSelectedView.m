...
+ (instancetype)deviceSelectedViewWithTitle:(NSString *)title detailArray:(NSArray *)detailArray selectedDeviceResult:(ZLDeviceSelectedViewHandler)result{
    return [self deviceSelectedViewWithTitle:title detailArray:detailArray storeKey:nil selectedDeviceResult:result];
}

+ (instancetype)deviceSelectedViewWithTitle:(NSString *)title detailArray:(NSArray *)detailArray {
    return [self deviceSelectedViewWithTitle:title detailArray:detailArray selectedDeviceResult:nil];
}
...
- (instancetype)initWithTitle:(NSString *)title detailArray:(NSArray *)detailArray selectedDeviceResult:(ZLDeviceSelectedViewHandler)result{
    return [self initWithTitle:title detailArray:detailArray storeKey:nil selectedDeviceResult:result];
}

- (instancetype)initWithTitle:(NSString *)title detailArray:(NSArray *)detailArray {
    return [self initWithTitle:title detailArray:detailArray selectedDeviceResult:nil];
}
                     ...
                     animations:^{
                         ...
                         if (section != nil) {
                             ...
                             if (model.isCanChoice) {
                                 model.selected = YES;
                                 [self zl_selectedHeader:header didSelected:YES section:sectionInteger];
                             }
                         }
...
- (void)setDetailArray:(NSArray *)detailArray {
    ...
    WS(weakSelf);
    __block NSInteger count = (self.detailArray.count <= 3) ? self.detailArray.count : 3;
    if (self.isFirstIncome) {
        [self.tableView mas_remakeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(weakSelf);
            make.width.equalTo(weakSelf).multipliedBy(0.7);
            self.tableViewOriginHeight = headerHeight * count + titleFooterHeight * 2;
